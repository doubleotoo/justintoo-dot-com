...
;(function($) {
  $.fn.onePageNav = function(options) {
    ...
    onePageNav.adjustNav = function($this, $el, o) {
    ...
    onePageNav.getFirstSection = function($this, o) {
    ...
    onePageNav.getSection = function($this, windowPos, o) {
      ...
      {
          // first section when we hit the top of the document
          returnValue = onePageNav.getFirstSection($this, o);
      }
      else
      {
    ...
    onePageNav.scrollChange = function($this, o) {
      if (clicked) {
        ...
        if(position !== '') {
          onePageNav.adjustNav($this,$this.find('a[href=#'+position+']'), o);
        }
      }
    };
